...
TQ_detection <- TQ_detection %>%
  select(-EARDetected, -TQ_total, -Diff)
...
ggsave(file_out(file.path(path_to_data, "Figures/StackBar_ByEAR_Bychem2_watersamples.png")), plot = chemicalbyEAR2, height=4, width=6)
...
ggsave(file_out(file.path(path_to_data, "Figures/StackBar_ByTQ_Bychem2_watersamples.png")), plot = TQ_detection2, height=4, width=6)
...
ggsave(file_out(file.path(path_to_data, "Figures/StackBox_ByEAR_BySite2_watersamples.png")), plot = sitebyEAR2, height=4, width=6)
